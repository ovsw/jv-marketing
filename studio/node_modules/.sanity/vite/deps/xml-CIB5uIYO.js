//#region ../node_modules/.pnpm/@codemirror+legacy-modes@6.5.3/node_modules/@codemirror/legacy-modes/mode/xml.js
var htmlConfig = {
	autoSelfClosers: {
		"area": true,
		"base": true,
...
function mkXML(parserConfig) {
	...
	return {
		...
		indent: function(state, textAfter, cx) {
			...
			else return state.tagStart + cx.unit * (config.multilineTagIndentFactor || 1);
