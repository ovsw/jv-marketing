...
import { jb as motion } from "./lib-eSrpwKdU.js";
//#region ../node_modules/.pnpm/sanity@6.4.0_@babel+core@7.29.7_@babel+runtime@7.29.7_@emotion+is-prop-valid@1.4.0_@nob_289e8bf2eda51c34c39dfe3753902bd9/node_modules/sanity/lib/_chunks-es/QRCodeSVG.js
...
function getImageSettings(cells, size, margin, logoSize) {
	...
	const scale = (cells.length + margin * 2) / size, w = logoSize * scale, h = logoSize * scale, x = cells.length / 2 - w / 2, y = cells.length / 2 - h / 2, floorX = Math.floor(x), floorY = Math.floor(y);
	return {
		x,
		y,
		h,
...
function useQRCode(t0) {
	const $ = (0, import_compiler_runtime.c)(24), { value, level, minVersion, includeMargin, marginSize, logoSize, size } = t0;
	let t1;
...
function QRCodeSVGComponent(props) {
	const $ = (0, import_compiler_runtime.c)(26), { value, size: t0, level: t1, color: t2, minVersion: t3, title, logoSize } = props, size = t0 === void 0 ? DEFAULT_SIZE : t0, level = t1 === void 0 ? DEFAULT_LEVEL : t1, color = t2 === void 0 ? DEFAULT_FGCOLOR : t2, minVersion = t3 === void 0 ? DEFAULT_MINVERSION : t3;
	let t4;
	...
	let t8;
	$[13] !== title ? (t8 = !!title && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("title", { children: title }), $[13] = title, $[14] = t8) : t8 = $[14];
	let t10, t11, t9;
	$[15] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t9 = { opacity: 0 }, t10 = { opacity: 2 }, t11 = { opacity: -1 }, $[15] = t10, $[16] = t11, $[17] = t9) : (t10 = $[15], t11 = $[16], t9 = $[17]);
	let t12;
	$[18] !== color || $[19] !== fgPath ? (t12 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.path, {
		fill: color,
		d: fgPath,
	...
	let t13;
	return $[21] !== size || $[22] !== t12 || $[23] !== t7 || $[24] !== t8 ? (t13 = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
		height: size,
		width: size,
		viewBox: t7,
		role: "img",
