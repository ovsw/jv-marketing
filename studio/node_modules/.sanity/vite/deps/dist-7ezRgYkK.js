import { C as indentNodeProp, Dt as tags, Et as styleTags, _ as foldInside, d as continuedIndent, o as LanguageSupport, r as LRLanguage, y as foldNodeProp } from "./dist-B8jp92mr.js";
import { i as LocalTokenGroup, r as LRParser } from "./dist-yDdLw1Ri.js";
//#region ../node_modules/.pnpm/@sanity+lezer-groq@1.0.4/node_modules/@sanity/lezer-groq/dist/index.js
var groqHighlighting = styleTags({
...
var parser = LRParser.deserialize({
	...
	tokenizers: [
		2,
		3,
		new LocalTokenGroup("#r~RQrsX#O#P^~^Og~~aTO#ip#i#ju#j;'Sp;'S;=`#i;=`Op~uOf~~zSf~!Q![!W!c!i!W#T#Z!W#o#p!|~!ZR!Q![!d!c!i!d#T#Z!d~!gR!Q![!p!c!i!p#T#Z!p~!sR!Q![p!c!ip#T#Zp~#PR!Q![#Y!c!i#Y#T#Z#Y~#]S!Q![#Y!c!i#Y#T#Z#Y#q#rp~#nPf~;=`<%lp~", 125, 110),
		new LocalTokenGroup("#r~RQwxX#O#P^~^Oj~~aTO#ip#i#ju#j;'Sp;'S;=`#i;=`Op~uOi~~zSi~!Q![!W!c!i!W#T#Z!W#o#p!|~!ZR!Q![!d!c!i!d#T#Z!d~!gR!Q![!p!c!i!p#T#Z!p~!sR!Q![p!c!ip#T#Zp~#PR!Q![#Y!c!i#Y#T#Z#Y~#]S!Q![#Y!c!i#Y#T#Z#Y#q#rp~#nPi~;=`<%lp~", 125, 112)
	],
	topRules: { "Query": [0, 2] },
	specialized: [{
		term: 5,
...
var groqLanguage = LRLanguage.define({
	name: "groq",
	...
	}), foldNodeProp.add({ "Projection ObjectLiteral ArrayLiteral Filter": foldInside })] }),
	languageData: {
